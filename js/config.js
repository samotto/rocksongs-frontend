...
(function configureRockSongs() {
  const REMOTE_API_BASE_URL = "https://YOUR-RAILWAY-BACKEND-DOMAIN";
  // Current development mode. Change to "remote" when publishing to GitHub Pages.
  const ENVIRONMENT_OVERRIDE = "local";
